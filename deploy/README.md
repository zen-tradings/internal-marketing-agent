...
```bash
npm run deploy:digitalocean -- --commit "$(git rev-parse HEAD)" --max-concurrency 1 --opening-digest-model openai/gpt-oss-120b --opening-digest-wechat-enabled true --activate
```
