...
2. 结构完整:保持标题层级、正文段落、列表、图片顺序、图号与图注、表格行列、公式、代码和引用关系。原图不重绘,只翻译图注;表格文字逐单元格翻译;公式、代码、作者名、DOI、URL 和引用编号保持不变。
