...
| Customer.io 邮件草稿 | `src/workflows/email.js` + `src/channels/customerio-draft.js` | 固定 `zen-customerio/zen-research@3`，页脚地址固定为 `700 Leahy St`，只创建草稿；受众由 internal/pilot/full 三阶段配置控制 |
