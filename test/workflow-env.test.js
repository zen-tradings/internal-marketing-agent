...
test('Opening Digest 保留价格事实，但禁止解释没有催化原因', async () => {
  const originalGlobalModel = process.env.OPENROUTER_MODEL;
  const originalOpeningModel = process.env.OPENING_DIGEST_MODEL;
  delete process.env.OPENING_DIGEST_MODEL;
